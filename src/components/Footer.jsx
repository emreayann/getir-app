        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <svg className="h-8 w-auto text-purple-400" viewBox="0 0 120 40" fill="currentColor">
            ...
            <p className="text-gray-300 text-sm">
              Dakikalar içinde kapında. Binlerce ürün, yüzlerce kategori ile alışverişin keyfini çıkar.
            </p>
